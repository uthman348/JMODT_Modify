...
class KittiSequenceViewer:
    def __init__(self, root_dir, seq, output_dir, viewpoint_file, label_dir,
        ...
        # init visualizer
        self._vis = open3d.visualization.VisualizerWithOffscreen()    #self._vis = open3d.visualization.Visualizer() #Originally it is
        self._vis.create_window(visible=False)                        #self._vis.create_window()  #Originally it 
