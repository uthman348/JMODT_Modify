...
class Trainer:
    ...
    def train(self, start_it, start_epoch, n_epochs, train_loader, val_loader=None, stop_thres=5):
        ...
        prev_train_loss = -1
        prev_val_loss = -1
        val_loss_epoch = float('inf')  # Initialize to prevent UnboundLocalError
        counter = 0
        ...
        with tqdm.trange(start_epoch, n_epochs, desc='epochs') as tbar, \
            ...
            for epoch in tbar:
                ...
                if prev_train_loss != -1 and prev_val_loss != -1:
                    ...
                    prev_val_loss = val_loss_epoch if val_loader is not None else prev_val_loss

                if val_loader is not None and val_loss_epoch < min_val_loss:
